	...
	<div class="container">
		<div class="navbar">
			...
			<a href="/ProjectWeb/cart"> <img
				...
				src="${pageContext.servletContext.contextPath}/RedStore_Img/images/menu.png" class="menu-icon"
				onclick="menutoggle()" />
		</div>
	</div>
			...
			<table class="styled-table">
				...
				<c:forEach items="${bills}" var="bill">
					<tr>
						...
						<td><span> <a href="/ProjectWeb/member/bill/delete?billid=${bill.id }" class="btn">Delete</a> <a
								href="/ProjectWeb/member/billproduct?billid=${bill.id }" class="btn">Detail</a>
						</span></td>
					</tr>
					</c:forEach>
		...
		<div class="container">
			<div class="row">
				<div class="footer-col-1">
					...
					<div class="app-logo">
						<img src="${pageContext.servletContext.contextPath}/RedStore_Img/images/play-store.png" /> <img
